...
exports.setContact = exports.getPropertyDetails = exports.getEquipmentDetails = void 0;
...
var getPropertyDetails = function getPropertyDetails(id) {
  return _axios.default.get("".concat(propertyUrl, "/").concat(id)).then(function (_ref) {
    var data = _ref.data;
    return data;
  });
};
exports.getPropertyDetails = getPropertyDetails;
var equipmentUrl = "".concat("http://localhost:3000/api", "/equipments");
var getEquipmentDetails = function getEquipmentDetails() {
  return _axios.default.get(equipmentUrl).then(function (_ref2) {
    var data = _ref2.data;
    return data;
  });
};
...
var setContact = function setContact(contact) {
  return _axios.default.post(contactUrl, contact).then(function (_ref3) {
    var data = _ref3.data;
    return data;
  });
};
...
},{}],"pages/property-detail/property-list.validations.js":[function(require,module,exports) {
"use strict";
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"pages/property-detail/property-detail.mappers.js":[function(require,module,exports) {
"use strict";
...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"pages/property-detail/property-detail.js":[function(require,module,exports) {
"use strict";

var _helpers = require("../../common/helpers");
var _propertyDetail = require("./property-detail.api");
var _propertyList = require("./property-list.validations");
...
Promise.all([(0, _propertyDetail.getPropertyDetails)(params.id), (0, _propertyDetail.getEquipmentDetails)()]).then(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 2),
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _propertyList.formValidation.validateField('email', contact.email).then(function (result) {
...
(0, _helpers.onUpdateField)('message', function (event) {
  ...
  _propertyList.formValidation.validateField('message', contact.message).then(function (result) {
